...
export default function CatalogueSection() {
    const items = [
        ...
        },
        {
            ...
            image: "/image/kitchen1v.jpg",
            description: "family drowing room with a clean and comfortable design for your family.",
        },
        {
            id: "03",
            catagory: "OFFICE SETUP",
            title: "Office Setup for WFH",
            image: "/image/drowingv.jpg",
            description: "Office room with a clean and comfortable design for your Business.",
        },
        {
            id: "04",
            catagory: "LIVING SETUP",
            title: "Clean Family Room",
            image: "/image/livingv.jpg",
            description: "family drowing room with a clean and comfortable design for your family.",
        },
    ]
            ...
            {items.map((item) => (
                <div key={item.id} className="relative overflow-hidden group">
                    ...
                    <div className="absolute top-0 p-8 m-12 bg-white bg-opacity-60 backdrop-blur">
                        ...
                        <a className="inline-flex items-center font-medium" href="/gallery">See Details <TbArrowNarrowRight className="ml-2 text-xl " /></a>
                    </div>
