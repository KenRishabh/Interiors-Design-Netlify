            ...
            <div className="container lg:grid lg:grid-cols-2 py-14">
                <div className="grid gap-4 pb-4 text-left lg:pb-0 lg:grid-cols-3">
                    ...
                    <div>
                        ...
                        <div className="flex flex-col ">
                            <Link className="py-1 hover:underline" href="https://www.instagram.com/vishalinteriors/">Instagram</Link>
                            <Link className="py-1 hover:underline" href="https://www.linkedin.com/company/vishal-interiors/">Linkedin</Link>
                            <Link className="py-1 hover:underline" href="https://www.facebook.com/thevishalinteriors">Facebook</Link>
                        </div>
                    </div>
                </div>
            ...
            <div className="py-10 bg-zinc-200">
                <div className="container text-center text-gray-500 lg:justify-between lg:flex">
                    <div className="pb-4 lg:pb-0">
                        <p>&copy;Copyright 2025 © VISHAL INTERIORS. All rights reserved </p>
                    </div>
                    <div className="">
