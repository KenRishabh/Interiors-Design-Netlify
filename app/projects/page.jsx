...
export default function Projects() {
    const projects = [
        {
            id: 1,
            name: 'Master Bedroom for MANJUNATH RESIDENCY',
        ...
        {
            id: 3,
            name: 'Office Space for SSKT',
            description: 'Office space for corporate and business. charming whit a modern design. ',
