    ...
    return (
        ...
        <div class="container py-10 grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div class="flex flex-col gap-4">
                <div>
                    <img class="h-auto max-w-full rounded-lg" src="/image/badroom1.jpg" alt="" />
                </div>
                <div>
            ...
            <div class="flex flex-col gap-4">
                <div>
                    <img  class="h-auto max-w-full rounded-lg" src="/image/swipe1.jpg" alt="" />
                </div>
                <div>
                    <img  class="h-auto max-w-full rounded-lg" src="/image/gallery111.jpg" alt="" />
                </div>
                <div>
                    <img  class="h-auto max-w-full rounded-lg" src="/image/living1.jpg" alt="" />
                </div>
            </div>
            <div class="flex flex-col gap-4">
                <div>
